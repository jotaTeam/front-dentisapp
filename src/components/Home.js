			...
			<section className='home-header'>
				...
				<section className='home-options-cont'>
					<Link to='/citaprevia' className='link-cont'>
							...
							<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 500 500'>
								...
								<g id='Capa_2' data-name='Capa 2'>
									<g id='circle_white' data-name='circle white'>
										<circle className='cls-11' cx='250' cy='250' r='250' />
									</g>
									<g id='Capa_3' data-name='Capa 3'>
										<circle className='cls-22' cx='249' cy='251' r='212.5' />
									</g>
									<g id='Capa_4' data-name='Capa 4'>
										<rect
											...
											width='31'
											height='133'
											transform='translate(29 572) rotate(-90)'
										/>
										<rect
											className='cls-33'
											x='233.5'
						...
						<h3>
							<FormattedMessage id='home.date' defaultMessage='Cita Previa' />
						</h3>
						<p>
							<FormattedMessage
							...
							<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 500 500'>
								...
								<g id='Capa_2' data-name='Capa 2'>
									...
									<g id='Capa_7' data-name='Capa 7'>
										<circle className='cls-23' cx='249' cy='250' r='212.5' />
									</g>
